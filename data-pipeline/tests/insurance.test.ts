...
const SNAPSHOT: PartDSnapshot = {
  ...
  scope: {
    membersFetched: [{ name: "basic drugs formulary file.zip", compressedBytes: 8_300_000, uncompressedBytes: 8_600_000 }],
    membersSkipped: [{ name: "pharmacy networks file part 1.zip", uncompressedBytes: 409_000_000, reason: "not needed" }],
    formularyRowsRead: 1000,
    formularyRowsRetained: 4,
    formularyRowsRejectedRxcuiFilter: 996,
    planRowsRead: 10,
    planRowsUnique: 4,
    planRowsRejectedIncomplete: 0,
    costRowsRead: 1,
    excludedRowsRead: 0,
    rxcuisWithNoMatch: [],
    formularyIdsWithoutPlan: [],
    plansRetained: 4,
    plansDroppedNoMatchingFormulary: 0,
    costRulesRetained: 1,
    costRulesAvailable: 1,
  },
  plans: [
